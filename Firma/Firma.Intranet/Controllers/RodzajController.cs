...
namespace Firma.Intranet.Controllers
{
    public class RodzajController : Controller
    {
        ...
        public RodzajController(FirmaIntranetContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdRodzaju,Nazwa")] Rodzaj rodzaj)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRodzaju,Nazwa")] Rodzaj rodzaj)
        {
